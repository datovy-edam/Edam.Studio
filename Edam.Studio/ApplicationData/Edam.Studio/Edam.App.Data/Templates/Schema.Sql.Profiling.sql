...
-- Schema - Table - Column Data Profiling
...
CREATE PROCEDURE [Common].[DataProfileReportProc]
...
DECLARE @TABLE_SCHEMA NVARCHAR(128) = @tableName  -- Your schema here
DECLARE @TABLE_NAME NVARCHAR(128) = @columnName -- Your table here
...
-- EXEC [Common].[DataProfileReportProc] 'Activity','Attraction'
